        ...
        <div className="d-flex justify-content-around my-5">
            ...
            <div className="part_30 bs1">
                <div className="mx-3 pb-4 px-3">
                    ...
                    <h5 className='my-3'>Tenancy Law</h5>
                    <p className='pb-3'>We help tenants to enforce their rights in the case of rent control, rent increases, defects in the apartment, deposit reclaim.</p>
                    <a href="/" className="text-decoration-none"><b>Know More</b></a>
                </div>
            </div>
            <div className="part_30 bs1">
                <div className="mx-3 pb-4 px-3">
                    ...
                    <h5 className='my-3'>Traffic Law</h5>
                    <p className='pb-3'>We support customers in all cases related to traffic law, for example traffic accident, traffic offense, driving license, criminal offenses.</p>
                    <a href="/" className="text-decoration-none"><b>Know More</b></a>
                </div>
            </div>
        </div>
